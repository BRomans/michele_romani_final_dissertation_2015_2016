\chapter{The Choice}
\label{cha:2}
In this chapter we explain the motivations that determined  MongoDB as our choice for the evaluation, and consequently the commission, among other NoSQL possibilities.
...
As explained above, Mongo uses the BSON \footnote{Binary JavaScript Object Notation - http://bsonspec.org/} document format that is a binary representation for JSON documents, but with more data types.
