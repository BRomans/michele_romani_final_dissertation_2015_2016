...
%\textbf{Test} & \textbf{Threads} & \textbf{Nodes} & \textbf{Entries} & \textbf{Duration(s)} & \textbf{Avg Put Time(ms)} & \textbf{Avg Get Time(ms)} & \textbf{Max Put Time(ms)} & \textbf{Min Put Time(ms)} & \textbf{Max Get Time(ms)} & \textbf{Min Get Time(ms)} & \textbf{Throughput (op/s)} \\ \hline
%\rowcolor[HTML]{FFCE93} 
%1 & 1 & 1 & 200.000 & 5.298 & 14 & 18 & 10.902 & 14 & 10.907 & 18 & 75,50019 \\
%\rowcolor[HTML]{FFCE93} 
%4 & 35 & 1 & 2.000.000 & 9.074 & 29,8 & 34,4 & 5.004 & 18 & 5.113 & 21 & 190,87396 \\
%\rowcolor[HTML]{FFCE93} 
%6 & 35 & 2 & 2.000.000 & 8.440 & 28,85 & 31,53 & 1.651 & 14 & 1.691 & 16 & 195,43104 \\
%\rowcolor[HTML]{FFCE93} 
%10 & 35 & 2 & 2.000.000 & 8.047 & 28,8 & 31,4 & 1.422 & 18 & 1.531 & 21 & 195,28309 \\ \hline
%\end{tabular}
%\caption{My caption}
%\label{my-label}
%\end{table}
...
\begin{figure}[H]
\includegraphics[scale=0.6]{exec_times_new.png}
\centering
